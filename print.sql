...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 22, 2024 at 03:30 AM
...
(2, 'wahyudi', 'assets/img/no-pic.png', 'admin', '0192023a7bbd73250516f069df18b500');
...
(4, 1, 0, 'upload/hamka_irsal/1705008059.jpeg', 'dibuat menjadi menarik', 2, 3),
(5, 1, 0, 'upload/hamka_irsal/1706626023.jpeg', 'cetak baliho ukuran 5x3', 1, 4);
...
('Jln. Pesantren Lapajung, Kecamatan Lalabata, Kabupaten Soppeng, Sulawesi Selatan', 'helpdesk@efes.com', '08131235124', '0898509309', 'BRI', 'Arsyad Hakim', '141029410234021', 'https://www.facebook.com/', 'https://twitter.com/', 'https://www.instagram.com/');
...
(1, 'Uncategorized', ''),
(5, 'Spanduk', 'assets/img/produk/Indoor/kat-icon.png'),
(6, 'Baliho', 'assets/img/produk/Outdoor/kat-icon.png'),
(7, 'Stiker', 'assets/img/produk/Display/kat-icon.png');
...
INSERT INTO `konfirmasi_pembayaran` (`id_konfirmasi`, `nama_bank`, `nama_akun`, `no_rek`, `file_bukti`, `status`, `id_transaksi`) VALUES
(1, 'Mandiri', 'Adi Purnomo', '0124151212612', 'upload/bukti/pembayaran/1560852370.png', 1, 1),
(2, 'DKI', 'Alessa Sandra', '51210512012', 'upload/bukti/pembayaran/1561173009.png', 1, 2),
(3, 'BRI', 'hamka', '1234566788989', 'upload/bukti/pembayaran/1705008306.jpeg', 1, 3);
...
(1, 'hamka irsal hamka', 'hamkairsal23@gmail.com', 'Tempat percetakannya sangat bagus');
...
(3, '#TRK-0003', '2024-01-12 05:21:55', '6', '', NULL, NULL, 2085000, 2, 3),
(4, '#TRK-0004', '2024-01-30 22:56:56', '6', 'btn antara', NULL, NULL, 227900, 0, 3);
...
(3, 'Wahyudi', 'no-foto.png', 'wahyudi@gmail.com', '081241989060', '', '', '', '', '', '55a6e202801c2023bbccfcd77f979713');
